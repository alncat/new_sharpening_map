...
map_coeff_params_base_str = """\
    ...
    .style = auto_align
  {
    ...
    new_sharp = False
      .type = bool
      .help = Apply novel B-factor sharpening
      .short_caption = Apply novel B-factor sharpening
      .style = bold
    q_sharp = 20.0
      .type = float
      .help = user defined sharpening factor
    b_sharp = 20.0
      .type = float
      .help = user defined counter sharpening factor
...
def map_coefficients_from_fmodel(
  ...
  if(not params.kicked):
    coeffs = e_map_obj.map_coefficients(
      ...
      new_sharp          = params.new_sharp,
      q_sharp            = params.q_sharp,
      b_sharp            = params.b_sharp,
